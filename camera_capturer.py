...
class CameraCapturer(object):
    ...
    def rear_distortion_rectify(self, img):
        """ Fill this function when we get the parameters of the rear camera.
        To make the code more elegant, this function and be combined into
        front_distortion_rectify().
        """
        # The following parameters are generated by Matlab
        camera_matrix = np.array(
            [[1346.3, 0, 0],
        ...
        camera_matrix = camera_matrix.T
        distortion_coeffs = np.array([0, 0, 0, 0]).reshape(-1, 1)
